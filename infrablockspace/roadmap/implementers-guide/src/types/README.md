...
digraph {
    ...
    Id [label="parachain_primitives::primitives::Id"]
    ...
    PoV:block_data -> "parachain_primitives::primitives::BlockData":w
    ...
    HeadData [label = "parachain_primitives::primitives::HeadData"]

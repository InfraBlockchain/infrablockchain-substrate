...
/// Types of asset supported by the InfraBlockspace runtime.
pub enum AssetTypes {
...
// InfraBlockspace only knows about one asset, the balances pallet.
...
impl WeighMultiAssets for MultiAssetFilter {
	fn weigh_multi_assets(&self, balances_weight: Weight) -> Weight {
		match self {
			...
			// We don't support any NFTs on InfraBlockspace, so these two variants will always match
...
pub struct InfraBlockspaceXcmWeight<RuntimeCall>(core::marker::PhantomData<RuntimeCall>);
impl<RuntimeCall> XcmWeightInfo<RuntimeCall> for InfraBlockspaceXcmWeight<RuntimeCall> {
	...
	fn exchange_asset(_give: &MultiAssetFilter, _receive: &MultiAssets, _maximal: &bool) -> Weight {
		// InfraBlockspace does not currently support exchange asset operations
		Weight::MAX
	}
	...
	fn universal_origin(_: &Junction) -> Weight {
		// InfraBlockspace does not currently support universal origin operations
		Weight::MAX
	}
	fn export_message(_: &NetworkId, _: &Junctions, _: &Xcm<()>) -> Weight {
		// InfraBlockspace relay should not support export message operations
		Weight::MAX
	}
	fn lock_asset(_: &MultiAsset, _: &MultiLocation) -> Weight {
		// InfraBlockspace does not currently support asset locking operations
		Weight::MAX
	}

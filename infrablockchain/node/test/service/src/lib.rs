...
use infrablockchain_service::{Error, FullClient, IsParachainNode, NewFull, PrometheusConfig};
...
pub use infrablockchain_service::{FullBackend, GetLastTimestamp};
...
pub fn new_full(
	...
	infrablockchain_service::new_full(
		config,

...
#[cfg(feature = "full-node")]
pub use {
	infrablockchain_overseer::{Handle, Overseer, OverseerConnector, OverseerHandle},
...
pub enum Error {
	...
	Overseer(#[from] infrablockchain_overseer::SubsystemError),
...

		{
			...
			task_manager.spawn_essential_handle().spawn_blocking(
				...
				Box::pin(async move {
					...
					let forward = infrablockchain_overseer::forward_events(overseer_client, handle);

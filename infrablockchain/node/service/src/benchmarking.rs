...
pub fn benchmark_inherent_data(
	header: infrablockchain_core_primitives::Header,
	...
	let para_data = primitives::InherentData {
		bitfields: Vec::new(),
	...
	inherent_data.put_data(primitives::PARACHAINS_INHERENT_IDENTIFIER, &para_data)?;

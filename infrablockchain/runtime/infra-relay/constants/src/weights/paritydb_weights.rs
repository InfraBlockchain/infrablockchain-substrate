...
//!
//! DATABASE: `ParityDb`, RUNTIME: `infrablockspace`
//! BLOCK-NUM: `BlockId::Number(9653477)`
//! SKIP-WRITE: `false`, SKIP-READ: `false`, WARMUPS: `1`
//! STATE-VERSION: `V0`, STATE-CACHE-SIZE: `0`
//! WEIGHT-PATH: `runtime/infrablockspace/constants/src/weights/`
...
/// Storage DB weights for the `infrablockspace` runtime and `ParityDb`.
pub mod constants {
	use frame_support::{
		parameter_types,

...
/// Native Asset Hub executor instance.
pub struct AssetHubRuntimeExecutor;

impl sc_executor::NativeExecutionDispatch for AssetHubRuntimeExecutor {
	type ExtendHostFunctions = frame_benchmarking::benchmarking::HostFunctions;

	fn dispatch(method: &str, data: &[u8]) -> Option<Vec<u8>> {
		asset_hub_runtime::api::dispatch(method, data)
	}

	fn native_version() -> sc_executor::NativeVersion {
		asset_hub_runtime::native_version()
	}
}

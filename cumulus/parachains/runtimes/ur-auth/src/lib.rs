...
use parachains_common::{
	types::*, constants::*,impls::DealWithFees, opaque::*,
...
use frame_support::{
    ...
    parameter_types,
    traits::{fungible::HoldConsideration, LinearStoragePrice, AsEnsureOriginWithArg, ConstU32, ConstU64, ConstU8, ConstBool},
    weights::{
...
impl pallet_urauth::Config for Runtime {
    ...
    type RandomnessEnabled = ConstBool<false>;
    type AuthorizedOrigin = EnsureRoot<AccountId>;
}

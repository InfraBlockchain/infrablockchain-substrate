...
pub mod time {
	...
	frame_support::parameter_types! {
		pub EpochDurationInBlocks: BlockNumber =
			prod_or_fast!(1 * MINUTES, 1 * MINUTES, "INFRA_RELAY_EPOCH_DURATION");
	}
	...
	// <https://research.web3.foundation/en/latest/infrablockspace/BABE/Babe/#6-practical-results>
...
pub mod fee {
	...
	impl WeightToFeePolynomial for WeightToFee {
		...
		fn polynomial() -> WeightToFeeCoefficients<Self::Balance> {
			// in infrablockspace, extrinsic base weight (smallest non-zero weight) is mapped to
			// 1/10 CENT:
...
pub mod xcm {
	...
	pub mod body {
		...
		// The bodies corresponding to the infrablockspace OpenGov Origins.
